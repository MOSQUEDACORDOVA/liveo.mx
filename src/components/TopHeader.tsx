    ...
    <div className="flex gap-2 justify-between text-white items-center px-4 sm:px-8 py-2 text-sm bg-light-violet font-semibold cursor-default">
      <div className="flex gap-x-4 flex-wrap">
        ...
        <p className="hidden lg:block">
          ...
          <a href="tel:5541641512" className="hover:text-violet duration-200 whitespace-nowrap">
            <PhoneIcon fontSize="small" className="rotate-[10deg] ml-1 -mt-1" /> 55 4163 4512
          </a>{" "}
          - Lunes a viernes de 8 a 17:30 horas
        </p>
      </div>
      <Link to={PathNames.companies} className="flex items-center gap-2 hover:text-violet duration-200">
        <StoreIcon />
